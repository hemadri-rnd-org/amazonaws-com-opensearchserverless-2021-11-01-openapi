# OpenSearch Service Serverless MCP Server

This MCP (Model Content Protocol) server provides access to OpenSearch Service Serverless API functionality through HTTP, HTTPS, and STDIO transport modes.
